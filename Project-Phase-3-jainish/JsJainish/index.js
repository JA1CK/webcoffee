...
function ChangeImages(direction) {
  ...
  background: url(/webcoffee/Project-Phase-3-jainish/imagesJainish/${homeImagesArray[ImageNumber]}) no-repeat;
...
function showImage(ref,i) {
  ref.innerHTML = `<img src="/webcoffee/Project-Phase-3-jainish/imagesJainish/barista-${i}.jpg" alt="team-member-${i}"/>`;
}